...
CREATE TABLE LECTOR (
    ...
    TRABAJO CHAR(10) NOT NULL CHECK (TRABAJO IN ('EMPLEADO', 'EJECUTIVO', 'VENDEDOR', 'COMERCIANTE')),
...
CREATE TABLE PRESTAMO (
    ...
    FOREIGN KEY (NRO_LECTOR) REFERENCES LECTOR (NRO_LECTOR) CHECK (ESTADO = 'H'),
    FOREIGN KEY (NRO_LIBRO, NRO_COPIA) REFERENCES COPIAS (NRO_LIBRO, NRO_COPIA) CHECK (ESTADO != 'N')
);
